var m = (function app(window, undefined) {
    ...
    for (var attrName in dataAttrs) {
      ...
      if (!(attrName in cachedAttrs) || (cachedAttr !== dataAttr)) {
        ...
        try {
          ...
          //hook event handlers to the hand-redrawing system
          else if (typeof dataAttr === FUNCTION && attrName.indexOf("hon") === 0) {
            node[attrName.slice(1)] = handredraw(dataAttr, node)
          }
  ...
  function handredraw(callback, object) {
    return function(e) {
      e = e || event;
      // m.redraw.strategy("diff");
      // m.startComputation();
